...
const tld = '.lobster';
const CONTRACT_ADDRESS = '0xED81e286066C618B10d897C729E316fE0fa0FaA1';
...
const App = () => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://i.gifer.com/7kH.gif" alt="lobster donut gif" />
		...
		if (network !== 'Polygon Mumbai Testnet') {
			...
			return (
				<div className="connect-wallet-container">
					...
					<img src="https://media4.giphy.com/media/3ohzdFHDBEG32PmWJO/giphy.gif" alt="lobster donut gif" />
		...
		return (
			<div className="form-container">
				...
				<input
					type="text"
					value={record}
					placeholder='whats ur lobster power?'
		...
		<div className="App">
			<div className="container">
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title"> &#127544; Lobster Name Service</p>
							<p className="subtitle">Welcome to this magical world! &#127926;</p>
						</div>
